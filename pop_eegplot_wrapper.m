...
function com = pop_eegplot_wrapper( EEG, icacomp, superpose, reject, topcommand, varargin)
...
if icacomp == 1
	eegplot_wrapper( EEG.data, 'srate', EEG.srate, 'title', 'Effective intervals -- eegplot_wrapper()', ...
	...
	eegplot_wrapper( tmpdata, 'srate', EEG.srate, 'title', 'Effective intervals -- eegplot_wrapper()', ...
			 'limits', [EEG.xmin EEG.xmax]*1000 , 'command', command, eegplotoptions{:}, varargin{:}); 
end;
